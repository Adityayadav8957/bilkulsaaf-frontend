...
/** Ported from Design /mobile.html + desktop.html — same stroke-based icon style used across the prototypes. */

export function SearchIcon({ className, size = 17 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShareIcon({ className, size = 17 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookmarkIcon({ className, size = 16, filled = false }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function MoreIcon({ className, size = 17 }: IconProps) {
  return (
